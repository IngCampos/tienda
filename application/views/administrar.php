...
<?php 
	...
	// Podemos utilizar el @ antes de la funcion para omitir el notice si no es una imagen.
		...
		try {
			...
			$sql = "INSERT INTO productos (nombre, descripcion, precio, imagen, Categorias_id, Cantidad) 
				VALUES ('$nombre', '$descripcion', $precio, '$img', $categoria, '$cant')";
...
<div id="content" class="form-row jumbotron">
	...
	<input class="form-control" type="number" name="cantidad" id="cantidad" style="width: 100px" min="0">
	</div>
